...
public class ShelterOrphanUpdateAction extends BaseAction {
	...
	protected String doExecute(ActionForm form, HttpServletRequest request,
		...
		if(request.getParameter("btnSearch")!=null)
		{
			...
			String AdopterNRC=myForm.getFrmAdopterNRC();
			System.out.println(AdopterNRC);
			if(myForm.getFrmAdopterNRC().equals(""))
			{
				errors.add("AdopNRCError1", new ActionMessage("errors.adoNrc1"));
				saveErrors(request, errors);
				myForm.setFrmAdopterFormControl(null);
				return "gotoUpdate";
			}
			if(!AdopterNRC.matches("^([1-9]|10|11|12|13|14)/[A-Z a-z]{6,7}[(][N,A][)]\\d{6}$"))
			{
				System.out.println("Error Name===========");
				errors.add("AdopNRCError", new ActionMessage("errors.adoNrc"));
				saveErrors(request, errors);
				myForm.setFrmAdopterFormControl(null);
				return "gotoUpdate";
			}
			myOrphanService.checkAdopterNRCName(myForm);
			if (myForm.getFrmAdopterNRCError() == null) 
			{
				...
				/*System.out.println("not Error Name========");*/
