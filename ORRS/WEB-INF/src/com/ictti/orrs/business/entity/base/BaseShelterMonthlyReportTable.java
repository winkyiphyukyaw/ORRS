...
/**
 * This is an object that contains data related to the shelter_monthly_report_view table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="shelter_monthly_report_view"
 */

public abstract class BaseShelterMonthlyReportTable  implements Serializable {

	public static String REF = "ShelterMonthlyReportTable";
	...
	// constructors
	public BaseShelterMonthlyReportTable () {
		initialize();
	}
	 ...
	 */
	public BaseShelterMonthlyReportTable (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.ictti.orrs.business.entity.ShelterMonthlyReportTable)) return false;
		else {
			com.ictti.orrs.business.entity.ShelterMonthlyReportTable shelterMonthlyReportTable = (com.ictti.orrs.business.entity.ShelterMonthlyReportTable) obj;
			if (null == this.getId() || null == shelterMonthlyReportTable.getId()) return false;
			else return (this.getId().equals(shelterMonthlyReportTable.getId()));
		}
	}
