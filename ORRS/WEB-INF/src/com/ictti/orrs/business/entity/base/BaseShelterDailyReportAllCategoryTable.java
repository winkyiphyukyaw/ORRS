...
/**
 * This is an object that contains data related to the shelter_daily_report_all_category_view table.
...
public abstract class BaseShelterDailyReportAllCategoryTable  implements Serializable {

	public static String REF = "ShelterDailyReportAllCategoryTable";
	...
	// constructors
	public BaseShelterDailyReportAllCategoryTable () {
		initialize();
	}
	 ...
	 */
	public BaseShelterDailyReportAllCategoryTable (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.ictti.orrs.business.entity.ShelterDailyReportAllCategoryTable)) return false;
		else {
			com.ictti.orrs.business.entity.ShelterDailyReportAllCategoryTable shelterDailyReportAllCategoryTable = (com.ictti.orrs.business.entity.ShelterDailyReportAllCategoryTable) obj;
			if (null == this.getId() || null == shelterDailyReportAllCategoryTable.getId()) return false;
			else return (this.getId().equals(shelterDailyReportAllCategoryTable.getId()));
		}
	}
